...
\begin{figure}[!ht]
    ...
    \hfil
    \subfloat[]{\includegraphics[width=0.48\linewidth]{results/wired_upnp_latency.png}
...
\begin{figure}[!ht]
    ...
    \hfil
    \subfloat[]{\includegraphics[width=0.48\linewidth]{results/wired_upnp_robustness.png}
...
\begin{figure}[!ht]
    \centering
    \subfloat[]{\includegraphics[width=1\linewidth]{results/mqtt_latency.png}
...
\begin{figure}[!ht]
    \centering
    \subfloat[]{\includegraphics[width=1\linewidth]{results/mqtt_robustness.png}
